...
import * as listAccountActions from './../../../actions/Admin/listAccount';
...
const http = "http://localhost:8080/api/admin/accountmanager";
const loadHttp = '/admin/accountmanager';
...
function QuanLiNhanVien(props) {
    ...
    const fileName = 'Table Quản lí tài khoản ';
    ...
    let headers = [
        ...
        { label: "Tên quản lí", key: "fullName" },
...
const mapStateToProps = state => {
    return {
        ...
        showAccount: state.adminAccountReducer.listAccount,
        initialValues: state.adminAccountReducer.taskEditting
    };
};
...
const FORM_NAME = 'TASK_ACCOUNT_ADMIN';
