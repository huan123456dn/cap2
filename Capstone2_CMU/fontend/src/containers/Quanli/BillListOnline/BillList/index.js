...
import * as billListActions from '../../../../actions/QuanLi/BillListOnline/billList';
import * as billListApi from '../../../../apis/QuanLi/billListOnline';
...
const http = "http://localhost:8080/api/manager/onlinebilllist";
const returnHttp = '/manager/';
const loadHttp = '/manager/onlinebilllist';
...
function BillListManager(props) {
    ...
    const fileName = 'Table Danh Sách hóa đơn điện tử';
    ...
    const handleBillProduct = listProduct => {
        ...
        history.push(`/manager/onlinebilllist/${listProduct._id}`, [listProduct._id])
    }
    ...
    const tableHeader = <thead className='bgvi'>
        <tr>
            ...
            <th className='table__center'>Hình thức mua</th>
    ...
    let headers = [
        ...
        { label: "Hình thức mua", key: "payments" }
    ];
...
const mapStateToProps = state => {
    return {
        showProduct: state.manageBillListOnlineReducer.billList,
        initialValues: state.manageBillListOnlineReducer.taskEditting
    };
};
