...
import * as listProductActions from './../../../actions/QuanLi/listProduct';
...
const http = "http://localhost:8080/api/manager/druglist";
const loadHttp = '/manager/druglist';
...
function DanhSachThuoc(props) {
    ...
    const fileName = 'Table Danh Sách Thuốc';
    let limit = 10;
