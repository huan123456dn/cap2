...
import ProductItem from '../../../components/User/ChamSocCaNhan';
...
function ChamSocCaNhan(props) {
    ...
    const renderProducts = () => {
        ...
        const taskFiltered = listProduct.filter(task => task.status === STATUS.task_CSCN);
